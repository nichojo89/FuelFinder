...
class MarkerInfoWindowAdapter(private val context: Context) : GoogleMap.InfoWindowAdapter {
    override fun getInfoContents(marker: Marker): View? {
        ...
        view.findViewById<TextView>(R.id.tv_title).text = place.name
        view.findViewById<TextView>(R.id.tv_address).text = place.address
        view.findViewById<TextView>(R.id.tv_rating).text = "Rating: %.2f".format(place.rating)
